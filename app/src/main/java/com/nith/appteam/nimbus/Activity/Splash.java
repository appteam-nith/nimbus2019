...
//                        Log.v("DISPLAY ME",sharedPref.getHashedValue());
//                        Log.v("DISPLAY YOU",sharedPref.getUserId());
//                        Toast.makeText(Splash.this, sharedPref.getUserId(), Toast.LENGTH_SHORT).show();
