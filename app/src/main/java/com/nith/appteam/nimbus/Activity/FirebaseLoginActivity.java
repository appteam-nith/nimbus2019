...
//        {
//            startActivity(new Intent(FirebaseLoginActivity.this,HomescreenNew.class));
//            finish();
//        }
...
//                Toast.makeText(FirebaseLoginActivity.this,hashed_value,Toast.LENGTH_SHORT).show();
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST,"https://nimbus2019.herokuapp.com/auth/signup", new com.android.volley.Response.Listener<String>() {
                    @Override
...
//                        Toast.makeText(FirebaseLoginActivity.this,HashedValue,Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent = new Intent(FirebaseLoginActivity.this, ProfileNew.class);
    ...
    private void saveUserLoginData(final String phone_no, String fb_id) {
        ...
        userSentResponseCall.enqueue(new Callback<UserSentResponse>() {
            @Override
            public void onResponse(Call<FirebaseLoginActivity.UserSentResponse> call, Response<UserSentResponse> response) {
