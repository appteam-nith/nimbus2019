...
public class NewsfeedTry extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        coordinatorLayout =  findViewById(R.id.core_try_view);
    ...
    public void upload(View view) {
        ImageView news = findViewById(R.id.newsfeedbutton);
                ...
                if (add.title != null && add.detail != null)
                    if (!add.title.isEmpty() && !add.detail.isEmpty()) {
                        if (!pref.getFirstTimeRollregister())
                            ...
                            recyclerView.setVisibility(View.VISIBLE);
                            ImageView uploadbutton =  findViewById(R.id.uploadbutton);
                            ImageView newsfeedbutton =  findViewById(R.id.newsfeedbutton);
...
//                            }
    ...
    public void newsfeed(View view) {
        ...
        newsfeedbutton.setVisibility(View.GONE);
        uploadbutton.setVisibility(View.VISIBLE);
        ImageView selectImage = findViewById(R.id.select_image);
        ImageView uploadnews = findViewById(R.id.upload_news);
        selectImage.setVisibility(View.GONE);
        uploadnews.setVisibility(View.GONE);
