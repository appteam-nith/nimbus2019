...
public class SharedPref {
    ...
    public String getHashedValue() {
        return sharedPreferences.getString(HASHED_VALUE,"");
    }
    ...
    public boolean getappactivityfirsttime(String clubname){
        return sharedPreferences.getBoolean(clubname,true);
    }
    public void setappactivityfirsttime(String clubname){
