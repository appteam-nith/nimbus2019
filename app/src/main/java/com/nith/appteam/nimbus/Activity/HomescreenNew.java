...
//        toolbar.setBackgroundColor(Color.WHITE);
        getSupportActionBar().setTitle("NIMBUS 2K19");
...
//
    ...
    public void onClickTeams2(View view)
    {
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.departmentalteamCard));

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {

                Intent intent = new Intent(HomescreenNew.this,TeamActivity.class);
                intent.putExtra("check","Departmental Teams");
...
//
    ...
    public void onClickTeams(View view) {
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.coreteamcard));
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(HomescreenNew.this,TeamActivity.class);
                intent.putExtra("check","CoreTeam");
                startActivity(intent);
            }
        }, 250);
...
//
    ...
    public void onClickCoreTeam(View view) {
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.FacultyCoreTeamCard));
    ...
    public void onClickNewsfeed(View view) {
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.NewsFeedCard));
    ...
    public void onClickGallery(View view) {
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.GalleryCard));

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(HomescreenNew.this, GalleryNew.class));
            }
        }, 250);
    ...
    public void onClickMap(View view) {
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.MapCard));
    ...
    public void onClickSponsors(View view) {
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.SponsorsCard));
    ...
    public void onClickQR(View view){
        YoYo.with(Techniques.TakingOff)
                .duration(500)
                .repeat(0)
                .playOn(findViewById(R.id.QRCARD));

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(HomescreenNew.this,Scannerqr.class));
            }
        }, 250);
    ...
    private void loadNavHeader() {
        ...
        imgNavHeaderBg.setImageDrawable(getResources().getDrawable(R.drawable.blue));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.profile:
                        startActivity(new Intent(HomescreenNew.this,ShowProfile.class));
                        drawer.closeDrawers();
                        return true;
